  ...
  return (
    <div className="container my-5">
      ...
      <div className="text-center mb-5">
        ...
        <p className="lead">
        We are Team foodapp, a group of four passionate innovators on a mission to revolutionize food distribution and eliminate food waste. Combining technology with social impact, our team is committed to creating a seamless, community-driven platform that connects surplus food from donors to those in need.
        </p>
      </div>
